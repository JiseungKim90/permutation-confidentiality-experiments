"""
Exp 32: weight-perturbation robustness of sorted-spectrum fingerprints
on ResNet-50.

Caveat: only V1 and V2 are real pretrained checkpoints; other "bases"
are V1 + Gaussian noise (NOT real fine-tuning). Paper cites only the
V1/V2 distance from this script; CIFAR fine-tuning lineage is in
