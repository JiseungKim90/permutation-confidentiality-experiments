#!/usr/bin/env python3
"""Isolate search arithmetic for the normalized Gram-sketch campaign."""
...
def main() -> None:
    ...
    result = {
        ...
        "prespecified_followup_hypothesis": "changing only the normalized Gram sketch search arithmetic from float32 cosine subtraction to centered float64 Euclidean distance resolves any cancellation-induced failures",
